...
public class JFXappController implements Initializable {
    ...
    private Graph areaMathsGraph;

    @Override
    public void initialize(final URL url, final ResourceBundle rb) {
        mathsGraph = new Graph(lineGraph, 10);
        areaMathsGraph = new Graph(areaGraph, 10);
    }
    ...
    @FXML
    private void handleExponentButtonAction(final ActionEvent event) {
        plotLine(x -> 3*(Math.exp(x/1) - 1));
    }
